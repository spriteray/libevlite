...
void * kqueue_init()
{
    ...
    poller->events = (struct kevent *)calloc( NEVENTS, sizeof(struct kevent) );
    poller->changes = (struct kevent *)calloc( NEVENTS, sizeof(struct kevent) );
